...
def setting_markup2():
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="❤", callback_data="Ruhsuzbeyyy"
            ),
        ],
        [
...
def start_pannel():
    if not SUPPORT_CHANNEL and not SUPPORT_GROUP:
        buttons = [
            [
                InlineKeyboardButton(
                    text="🗂 yardım menu", callback_data="shikhar"
                ),
            ],
            [
                InlineKeyboardButton(
    ...
    if not SUPPORT_CHANNEL and SUPPORT_GROUP:
        buttons = [
            [
                InlineKeyboardButton(
                    text="🗂 Helper Commands Menu", callback_data="ruhsuzbeyyy"
                ),
            ],
            [
                InlineKeyboardButton(
        ...
        return f"🎛  **bakaklım {MUSIC_BOT_NAME}*", buttons
...
def private_panel():
    ...
    if not SUPPORT_CHANNEL and SUPPORT_GROUP:
        buttons = [
            [
                InlineKeyboardButton(
                    text="🗂 Helper Commands Menu", callback_data="ruhsuz"
                ),
            ],
            [
                InlineKeyboardButton(
